    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            <thead class="bg-slate-50">
                <tr>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-slate-500 uppercase">Nama Anak</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-slate-500 uppercase">Orang Tua</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-slate-500 uppercase">Kontak</th>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-400">Lahir: {{ $a->birth_date->format('d M Y') }}</p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <p class="text-sm text-slate-400 truncate max-w-[150px]" title="{{ $a->address }}">{{ $a->address }}</p>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold 
                            ...
                            @endif">
                            @if($a->status == 'Pending') ⏳ Menunggu
                            @elseif($a->status == 'Accepted') ✅ Diterima
                            @else ❌ Ditolak
                            @endif
                        </span>
                    </td>
